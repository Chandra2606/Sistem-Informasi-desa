...
<head>
	...
	<title>SIDAK KENAGARIAN DUKU</title>
...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          <li>
            <a href="#" data-toggle="control-sidebar"><marquee><i class="fa fa-mortar-board"><font color="white"> </i><b>  Perancangan Sistem Informasi  Kependudukan pada Kantor Wali Nagari DUKU Berbasi Web </marquee></a>
          </li>
        </ul>
      </div>
    </nav>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> DUKU MAJU!</span>
			</a>
        ...
        ?>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="?page=data-rumah" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Data Rumah Penduduk</p>
									</a>
								</li>
							</ul>
						</li>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
				...
				case 'del-kartu':
					...
					//data rumah
				case 'data-rumah':
					include "admin/rumah/data_rumah.php";
					break;
				case 'add-rumah':
					include "admin/rumah/add_rumah.php";
					break;
				case 'edit-rumah':
					include "admin/rumah/edit_rumah.php";
					break;
				case 'anggota_rumah':
					include "admin/rumah/anggota_rumah.php";
					break;
				case 'del-anggota_rumah':
					include "admin/rumah/del_anggota_rumah.php";
					break;
				case 'del-rumah':
					include "admin/rumah/del_rumah.php";
					break;
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://wa.me/083182423488">
					<strong> Rafi Chandra</strong>
				</a>
				All rights reserved.
			</div>
			<b>CHANDRA26 VERSI 2021</b>
		</footer>
